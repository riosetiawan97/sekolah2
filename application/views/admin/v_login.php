...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?php echo base_url().'assets/metronic/media/illustrations/sketchy-1/14.png'?>)">
				<!--begin::Content-->
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="<?php echo site_url('admin/login');?>" class="mb-12">
            			<img width="200px;" src="<?php echo base_url().'assets/images/'.$setup->logo;?>">
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div>
		...
		<script src="<?php echo base_url().'assets/metronic/js/custom/authentication/sign-in/general.js'?>"></script>
