		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">List News</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
			</div>
			...
			<div class="d-flex align-items-center py-1">
				<!--begin::Button-->
				<a href="<?php echo base_url().'admin/tulisan/add_tulisan'?>" class="btn btn-sm btn-primary">
                    ...
                    <!-- /.box-header -->
                            <table id="example1" class="table table-striped table-bordered" style="font-size:13px;">
                                ...
                                <td style="text-align:right;">
                                    <a href="<?php echo base_url().'admin/tulisan/get_edit/'.$tulisan_id;?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    ...
                                    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#ModalHapus<?php echo $tulisan_id;?>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     <input type="hidden" value="<?php echo $tulisan_gambar;?>" name="gambar">
                            <p>Are you sure want to delete news <b><?php echo $tulisan_judul;?></b> ?</p>
