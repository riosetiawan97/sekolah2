	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<!--begin::Title-->
				<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Registration</h1>
				<!--end::Title-->
                <!--begin::Separator-->
...
<form action="<?php echo base_url().'admin/pendaftaran/update_pendaftaran'?>" method="post" enctype="multipart/form-data">
    ...
    <div class="box-body">
      ...
      <div class="form-group mb-4">
        ...
        <input type="text" name="formpendaftaran" class="form-control" id="formpendaftaran" value="<?php echo $b['formpendaftaran'];?>" placeholder="Registration Link">
      </div>
    </div>
