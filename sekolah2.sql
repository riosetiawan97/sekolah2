...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2024 at 06:56 PM
...
(19, 'User', 'User1@email.com', '0123456789', 'Tes Messege 240820241', '2024-08-24 10:03:24', 1);
...
--
ALTER TABLE `tbl_pengunjung`
  MODIFY `pengunjung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1985;
...
--
ALTER TABLE `tbl_youtube`
  MODIFY `youtube_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
